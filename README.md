...
This project extracts the video signal going to the ICS LCD panel and convertes it to composite to be used elsewhere.<br>
<br>
...
Thus, to remove the panel and still get video output, we need to generate them ourselves, this is what the STM32F411 does.<br>
...
Programming can be done with [STM32CubeProg](https://www.st.com/en/development-tools/stm32cubeprog.html) (Load Release/*.bin file or compile in the IDE).<br>
